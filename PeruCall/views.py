...
def agregarfiltro(request):
	...
	if request.method == 'POST':
		...
		up = "UPDATE base set status = 0 where campania = "+campania +" and status_f in "+ status_f+" and status_h in "+ status_h +" and status_g in "+ status_g+" and resultadotxt='' OR resultadotxt in "+resultado
