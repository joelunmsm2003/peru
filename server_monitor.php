...
system ("curl --data \"activeCall=$activeCall&dsk_use=$dsk_use&dsk_tot=$dsk_tot&total_mem=$total_mem&use_mem=$use_mem&total_swap=$total_swap&use_swap=$use_swap&CPU=$CPU&astCpuUse=$astCpuUse&astMemUse=$astMemUse&pytCpuUse=$pytCpuUse&pytMemUse=$pytMemUse&sqlCpuUse=$sqlCpuUse&sqlMemUse=$sqlMemUse\" \"http://localhost/astapp/\" >AstApp.html");

system ("curl --data \"activeCall=$activeCall&dsk_use=$dsk_use&dsk_tot=$dsk_tot&total_mem=$total_mem&use_mem=$use_mem&total_swap=$total_swap&use_swap=$use_swap&CPU=$CPU&astCpuUse=$astCpuUse&astMemUse=$astMemUse&pytCpuUse=$pytCpuUse&pytMemUse=$pytMemUse&sqlCpuUse=$sqlCpuUse&sqlMemUse=$sqlMemUse\" \"http://localhost/astapp/\" ");
